"""Locked tilt/perc disagreement peaks → 3kHz clicks on BS piano.

Clusters raw/tilt_high/k_env/k_env_adaptive (when peak_times exist) at ±30ms.
Keeps every cluster where NOT all included series are present.
Overlay style matches lpc_order_disagreement_on_piano packs.
"""
